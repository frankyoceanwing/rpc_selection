...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Reply Multiply(Args arg)")
  fmt.Fprintln(os.Stderr, "  Quotient Divide(Args arg)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := tf.NewArithClientFactory(trans, protocolFactory)
  ...
  case "Multiply":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Multiply requires 1 args")
      flag.Usage()
    }
    arg6 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.Multiply(value0))
    fmt.Print("\n")
    break
  case "Divide":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Divide requires 1 args")
      flag.Usage()
    }
    arg12 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.Divide(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
